...
static wiced_result_t ota2_config_load_dct_wifi(ota2_data_t* player)
{
    wiced_result_t result;
...
static wiced_result_t ota2_config_load_dct_network(ota2_data_t* player)
{
    wiced_result_t result;
...
static wiced_result_t ota2_config_unload_dct_wifi(ota2_data_t* player)
{
...
static wiced_result_t ota2_config_unload_dct_network(ota2_data_t* player)
{
    wiced_result_t result = WICED_SUCCESS;
